...
export class BFLProvider extends ImageProvider {
     ...
     */
    selectBestModel(prompt, width, height) {
     ...
     */
    async pollForResult(taskId, controller, apiKey, baseUrl = 'https://api.bfl.ml') {
        ...
        for (let i = 0; i < maxAttempts; i++) {
            ...
            const { statusCode, body } = await request(`${baseUrl}/v1/get_result?id=${taskId}`, {
                method: 'GET',
                headers: {
                    'X-Key': apiKey
                },
